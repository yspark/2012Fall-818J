...
To expand our work on mobile devices, we will develop an Android application. We will exploit the similarity of the Android platform with other UNIX-based OSs. 